  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      <GlassCard className="p-8 max-w-md w-full">
        <h1 className="font-display font-bold text-2xl tracking-head mb-6">Admin Login</h1>
        ...
        <Link href="/" className="mt-4 block text-center text-neonBlue hover:text-neonBlue/80 text-sm transition-colors">
          Back to home
        </Link>
      </GlassCard>
    </div>
